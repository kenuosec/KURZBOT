...
ɢɪᴛʜᴜʙ ᴏᴡɴᴇʀ:https://github.com/Wily
ʸᵒᵘᵗᵘᵇᵉ ᵒʷⁿᵉʳ:https://youtube.com/c/Wily`
sendButLocation(from, `${menu}`, "*_© Hentongers _*", {jpegThumbnail:logonya,name:""}, [{buttonId:`menu`,buttonText:{displayText:'SIAP OM'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break
case 'verify':
